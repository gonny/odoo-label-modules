...
class Label(models.Model):
    ...
    description = fields.Text(
        string='Description',
        help='Detailed description of the label'
    )
    ...
    label_type = fields.Selection([
        ...
        ('barcode', 'Barcode'),
        ('text', 'Text Only'),
    ], string='Label Type', default='barcode', required=True)
    ...
    size = fields.Selection([
        ...
        ('large', 'Large (15x20cm)'),
    ], string='Label Size', default='medium', required=True)
    
    active = fields.Boolean(
        string='Active',
        default=True,
        help='Set to false to archive the label'
    )
    ...
    printed_date = fields.Datetime(
        string='Printed Date',
        readonly=True,
        help='Date when the label was printed'
    )
    
    notes = fields.Html(
        string='Notes',
        help='Additional notes about the label'
    )
